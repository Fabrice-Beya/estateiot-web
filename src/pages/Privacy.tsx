          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="bg-gray-50 rounded-lg p-6 mb-8">
              <ul className="space-y-3 text-gray-700">
                ...
                <li><strong>Application</strong> refers to EstateIoT, the software program provided by the Company.</li>
                <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to EstateIoT.</li>
